...
fn runtime_menu_is_navigation_only_and_status_bar_is_stable_and_responsive() {
    ...
    assert!(RUNTIME_SOURCE.contains("STATUS_BAR_REGISTERS_COMPACT_WIDTH: f32 = 345.0"));
    assert!(RUNTIME_SOURCE.contains("STATUS_BAR_REGISTERS_EXTENDED_WIDTH: f32 = 615.0"));
    assert!(RUNTIME_SOURCE.contains("STATUS_BAR_EXTENDED_BREAKPOINT: f32 = 1260.0"));
