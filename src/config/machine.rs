...
impl CpuModel {
    ...
    /// Clock generated by the original Altair CPU board.
...
/// Host-side execution speed. This never changes the emulated CPU model or its
/// authentic 2 MHz hardware clock; it only changes how much virtual CPU time
/// RusTair advances per unit of host time.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
impl EmulationSpeed {
    ...
    pub const fn label(self) -> &'static str {
        match self {
            Self::Authentic => "Authentic 2 MHz",
            Self::X2 => "2x",
            Self::X5 => "5x",
            Self::X10 => "10x",
...
mod tests {
    ...
    #[test]
    fn classic_altair_cpu_is_8080_at_two_megahertz() {
