...
- Adaptive Full/Partial architectural differential and classic 8080 diagnostics.
...
The whole-machine explicit S-100 backplane architecture that was still parked at the time of this CPU certification was subsequently implemented. CPU board, RAM and I/O cards now communicate through the unified physical S-100 runtime and resolved backplane; that later architectural refactor does not weaken the CPU-board PASS claim above.
